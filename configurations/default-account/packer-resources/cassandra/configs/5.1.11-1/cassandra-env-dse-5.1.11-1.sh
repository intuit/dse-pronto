...
if [[ "$LOCAL_JMX" = "yes" ]]; then
  ...
  JVM_OPTS="$JVM_OPTS -Djavax.net.ssl.keyStore=/etc/dse/cassandra/keystores/server-keystore.jks"
  JVM_OPTS="$JVM_OPTS -Djavax.net.ssl.keyStorePassword=##KEYSTORE_PASS##"
  JVM_OPTS="$JVM_OPTS -Djavax.net.ssl.trustStore=/etc/dse/cassandra/keystores/server-truststore.jks"
